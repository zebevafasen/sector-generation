...
### Phase 4 - Completed
- Added: earlier core resolution in generation flow and core-aware POI radial influence input.
- Changed: core selection now runs before deep-space POI generation.
- Removed: no functional removals in this phase.
