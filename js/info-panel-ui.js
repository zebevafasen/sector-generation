...
export function getInfoPanelRefs() {
    return {
        ...
        factionCard: document.getElementById('infoFactionCard'),
        factionOwnerLabel: document.getElementById('infoFactionOwner'),
        factionControlStrengthLabel: document.getElementById('infoFactionControlStrength'),
        factionContestedLabel: document.getElementById('infoFactionContested'),
